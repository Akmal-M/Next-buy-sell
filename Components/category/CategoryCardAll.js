                            ...
                            <div>
                                {
                                    category === 'electronic' ?
                                        ...
                                        // <div
                                        //     className='absolute top-40 search-width left-1/2 transform -translate-x-1/2 bg-white shadow-2xl rounded-lg  text-gray-500 text-md whitespace-nowrap'>
                                        //
                                        ...
                                        category === 'vehicle' ?
                                            ...
                                            // <div
                                            //     className='absolute search-width left-1/2 transform -translate-x-1/2 top-40 bg-white shadow-2xl rounded-lg text-md text-gray-500  whitespace-nowrap'>
                                            //     <div className='flex justify-between'>
                                            //         <Link href='/vehicle'>
                                            //             <a><p
                                            //                 className='m-5 cursor-pointer bg-gray-400 rounded-md py-2 px-4 text-white hover:bg-gray-300'>
                        ...
                        <div>
                            {
                                category === 'business' ?
                                    ...
                                    // <div
                                    //     className='absolute search-width left-1/2 transform -translate-x-1/2 top-54 bg-white shadow-2xl rounded-lg text-md text-gray-500  whitespace-nowrap'>
                                    //
                                    //     <div className='flex justify-between'>
                                    //         <Link href='/business'>
                                    //             <a>
