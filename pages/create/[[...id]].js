                    ...
                    </div>
                    {
                        agree ?
                            <div className="flex lg:justify-end justify-center items-center py-5 gap-3">
                                <button type="submit"
                                        className="p-3 font-bold hover:bg-green-400 hover:text-white border-green-400 text-green-400 border-2 focus:outline-none outline-none rounded-md">Предпросмотр
                                </button>
                                <button type="submit"
                                        className="p-3 font-bold hover:bg-white bg-green-400 text-white hover:text-gray-700 border-green-400 border-2 focus:outline-none outline-none rounded-md">Опубликовать
                                </button>
                            </div> :
                            <div className="flex lg:justify-end justify-center items-center py-5 gap-3 opacity-20">
                                <button disabled={true}
                                        className="p-3 font-bold  border-green-400 border-2 focus:outline-none outline-none text-green-400 rounded-md">Предпросмотр
                                </button>
                                <button disabled={true}
                                        className="p-3 font-bold bg-green-400 text-white  border-green-400 border-2 focus:outline-none outline-none rounded-md">Опубликовать
                                </button>
                            </div>
                    }
                </form>
