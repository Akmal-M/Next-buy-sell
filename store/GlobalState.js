...
export const DataProvider = ({children}) => {
    ...
    //
    //     if(buy_sold_by_Akmal) dispatch({ type: 'ADD_CART', payload: buy_sold_by_Akmal })
    // }, [])
    //
    // useEffect(() => {
    //     localStorage.setItem('buy_sold_by_Akmal', JSON.stringify(cart))
    // }, [cart])
    //
    // useEffect(() => {
    //     if(auth.token){
