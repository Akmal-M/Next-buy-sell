        ...
        <div>
            ...
            <div className='relative'>
                ...
                <div className='max-w-5xl my-10 container mx-auto'>
                    ...
                    <div className={menu ? 'grid lg:grid-cols-5 mt-96' : 'grid lg:grid-cols-5'} onClick={() => setMenu(false)}>
...

                    {
                        ...
                        <div>
                            {
                                category === 'electronic' ?
                                    <div className='absolute search-width left-1/2 transform -translate-x-1/2 top-40 bg-white shadow-lg  text-gray-500 text-lg whitespace-nowrap'>
                                    ...
                                    category === 'vehicle' ?
                                        <div className='absolute search-width left-1/2 transform -translate-x-1/2 top-40 bg-white shadow-lg text-lg text-gray-500 text-xl whitespace-nowrap'>
                                            ...
                                            <div className='grid grid-cols-4 justify-center border-t border-gray-400 '>
                                                ...
                                                <div className='m-4  flex justify-center'>
                                                    <div className='m-4 '>
                                                        <Link href='/vehicle/children-auto-seat'>
                                                        <a>
                                                ...
                                                <div className='m-4  flex justify-center'>
                                                    <div className='m-4 '>
                                                        <Link href='/vehicle/other-goods-for-children'>
                                                        <a>
                            ...
                            { menus &&
                                                    ...
                                                    category === 'business' ?
                                                        <div className='absolute search-width left-1/2 transform -translate-x-1/2 top-96 bg-white shadow-lg text-lg text-gray-500 text-xl whitespace-nowrap'>
